...
import { deliveryList } from '../data/dummy';
import "./Order.css";
...
<div>
        ...
        <div className='mr-2 pt-4 grid text-sm font-medium  md:p-8 md:font-medium md:mr-10'>{product.name}

        {/* <p className='bar'>  {product.BarName} </p> */}
        </div>

        <li className=' rounded-full px-4 items-center flex  text-center md:text-lg text-sm mb-8 text-[#EF3838] bg-[#FFF1E8]  mr-1 mt-8 md:ml-8 md:mr-16 md:mt-8 font-medium'> {product.status} </li>


        <li className='ml-2 mr-1 mt-8 md:ml-8 md:mr-16 md:mt-8 font-medium'> {product.time} </li>
        <li className='ml-2 mr-1 mt-8 md:ml-8 md:mr-16 md:mt-8 font-medium'> {product.distance} </li>
        <li className='ml-2 mr-1 mt-8 md:ml-8 text-[#147D30] md:mr-16 md:mt-8 font-medium'> {product.price} </li>
